...
import { Plus, Search, Eye, FileText, Edit, Trash2, Filter, User, BookOpen, Calendar, ChevronLeft, ChevronRight, Send } from 'lucide-react';
...
const ObservationList = () => {
  ...
  const [publishModalSurvey, setPublishModalSurvey] = useState(null);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">调研与听课记录</h1>
            ...
            <div className="flex-1 flex flex-wrap gap-3">
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <option value="市北四实验">市北四实验</option>
                        <option value="青岛五十三中">青岛五十三中</option>
                    </select>
                </div>
            ...
            {currentItems.map((survey) => (
              <tr key={survey.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  ...
                  {hasPermission(user, 'canPublish') && survey.status !== 'published' && (
                    <button 
      ...
      {publishModalSurvey && (
        <SurveyPublishModal
          survey={publishModalSurvey}
          onClose={() => setPublishModalSurvey(null)}
